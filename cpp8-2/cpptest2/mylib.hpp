// ****************************************************************************************************************************
// 제 목 : shape클래스를 상속한 cirle, rect, triangle 클래스 함수작성 x, y는 private 생성자를 정의할때 호출할 기본클래스 생성자 명시
// 날 짜 : 2024년 11월 07일
// 작성자 : 2001186 박기안
// ****************************************************************************************************************************
...
public:
    Rect();
    ~Rect();
    Rect(int x, int y, int a, int b);//생성자 
    void show();//결과값출력 함수 선언
};
...
public:
    Triangle();
    ~Triangle();
    Triangle(int x, int y, int a, int b);//생성자 
    void show();//결과값출력 함수 선언
};
